...
?>
		...
		<div class="desc">
			...
			<div class="block">
				<p><small><?php echo $row[profession] ?></small><small id="updatefan<?php echo $row['id'] ?>"><?php echo $row['hot_count'] ?> Fans!</small></p>
                                <p><small>Like? &nbsp;<input type="checkbox" id="hot<?php echo $row[id] ?>" name="hot<?php echo $row[id] ?>" onclick="javascript:submitForm('<?php echo $hot_count ?>', '<?php echo $row[id] ?>'); "/></small><small><?php echo $row[name] ?></small></p>
                                <p><small><?php echo $row[email] ?></small></p>
                                <p><small><?php echo $row[address] ?></small></p>
                                <p><small><h5>MUSIC GENRE</h5><?php echo $row[musictype] ?></small></p>
			</div>
		</div>
	</div>
