...
function registerNewUser($location)
{
  ...
  if (isset($_POST['submit'])) {
    ...
    $message = "Register Step 2: " . $_POST[profession] . " " . $_POST[bmonth] . "-" . $_POST[bday] . "-" . $_POST[byear] . " " . $_POST[income] . " " . $_POST[gender] . " " . $_POST[height] . " " . $_POST[weight] . " " . $_POST[eyecolor] . " " . $_POST[haircolor] . " " . $_POST[hairstyle] . " " . $_POST[bodytype] . " " . $_POST[ethnicity] . " " . $_POST[persona] . " " . $_POST[otherincome] . " " . $_POST[othergender] . " " . $_POST[otherheight] . " " . $_POST[otherweight] . " " . $_POST[othereyecolor] . " " . $_POST[otherhaircolor] . " " . $_POST[otherhairstyle] . " " . $_POST[otherbodytype] . " " . $otherethnicity . " " . $_POST[otherpersona] . " " . $_POST[status] . " " . $_POST[otherstatus] . " " . $today . " " . $_POST[hobbies] . " " . $_POST[musictype] . " " . $location;
  ...
  if (isset($_POST['upload'])) {
       ...
       if ($error == UPLOAD_ERR_OK)
       {
        ...
        if($_POST[publicprofile] == 'on'){
         $thumbnail_path = '/home/users/web/b283/ipg.citicupidcom/publicimages/icons/' . $name;
             ...
             $make_magick = system("convert -geometry 600 x 0 $imagePath $thumbnail_path", $retval);
   ...
   $sql = "INSERT INTO soulmate (name, email, zip, created_on, images, publicprofile, referred_by, city) VALUES ('$_POST[fullname]', '$_POST[email]', '$_POST[zip]','$today', '$dbImageUrls', '$_POST[publicprofile]', '$_POST[referredBy]', '$location')"; 
    ...
    $subject = "New Sign Up";
    $headers = "From:" . $_POST[email];
    $message = "Register Step 1: " . $_POST[fullname] . " " . $_POST[email] . " " . $_POST[zip] . " " . $dbImageUrls . " " . $_POST[publicprofile] . " " . $location . " " . $_POST[referredBy];
    mail($to, $subject, $message, $headers);
