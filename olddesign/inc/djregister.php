...
for($i = 1; $i < count($_POST[musictype]); ++$i){
 ...
 $sql = "INSERT INTO hoster (name, email, zip, profession, bmonth, bday, byear, gender, images, created_on, musictype, referred_by, city) VALUES ('$_POST[fullname]', '$_POST[email]', '$_POST[zip]', '$_POST[profession]', '$_POST[bmonth]', '$_POST[bday]', '$_POST[byear]', '$_POST[gender]', '$dbImageUrls',  '$today', '$genre', '$_POST[referredBy]', '$location' )"; 
