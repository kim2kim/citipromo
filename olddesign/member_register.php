...
<div style="padding:10px;"><span style="color:gray;font-weight:bold;">Member Registration</span>  |  <a href="/signup.php?dj=1"><span>Promoter/DJ Registration</span></a></div>

<?php
 include("/home/users/web/b283/ipg.citicupidcom/inc/register.php");
 $showForm1 = registerNewUser("los angeles");
?>
...
<form id="uploadform" enctype="multipart/form-data" action="<?php echo $PHP_SELF;?>" method="POST" onSubmit="return validateThis(this);">
...
<div><div class="weebly-form-field" style="margin:5px 0px 5px 0px;">
  <label class="weebly-form-label" for="input-248748361112527009">Name </label>
  <div class="weebly-form-input-container">
...
<div ><div style="margin:5px 0px 5px 0px;">
  ...
  <div>
    <input  tabindex="4" type="text" name="zip" style="width:285px;" />
  </div>
</div>
</div>
...
<form id="signupform" method="POST" action="<?php echo $PHP_SELF;?>">
...
<div ><div class="weebly-form-field" style="margin:5px 0px 0px 0px;">
  ...
  <div style="padding:5px;">
    <span class='form-radio-container'><input  tabindex="11" type='radio' name='gender' value='male' />&nbsp;&nbsp;<label>  Male  </label></span>
  </div>
  <div style="padding:5px;">
<span class='form-radio-container'><input  tabindex="12" type='radio' name='gender' value='female' />&nbsp;&nbsp;<label>  Female  </label></span>
  </div>
</div></div>
