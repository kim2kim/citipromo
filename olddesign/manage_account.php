...
include("/home/users/web/b283/ipg.citicupidcom/inc/account.php");

<p>
Request a secret key to manage your account
</p>

<form action="<?php echo $PHP_SELF; ?>" method="POST" name="manageaccountform">
<div style="margin:10px 5px 10px 5px;">
<div class="weebly-form-field" style="margin:0px 0px 10px 0px;">
<?php if($_POST['email'] == '') { ?>
<label style="color:red;">Email:</label> &nbsp;&nbsp; <input type="text" name="email" style="width:300px;"/>
<?php } else { ?>
<label style="color:red;">Email:</label> &nbsp;&nbsp; <input type="text" name="email" value="<?php echo $_POST['email'] ?>"  style="width:300px;"/>
<?php } ?>
<input type="submit" name="manageaccountrequestsubmit" value="Submit"/>
</div>
</div>
</form>
...
<form action="<?php echo $PHP_SELF; ?>" method="POST" name="manageaccountform">
<caption>Verify Account</caption>
<div class="weebly-form-field" style="margin:0px 0px 10px 0px;">
<label style="color:red;">Secret Key:</label> &nbsp;&nbsp; <input type="text" name="secret_key" style="width:300px;"/>
<input type="submit" name="verifyaccountsubmit" value="Submit"/>
</div>
</form>
